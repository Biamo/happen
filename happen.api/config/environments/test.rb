Rails.application.configure do
  ...
  # exclusively to run your application's
  # test suite. You never need to
  # work with it otherwise. Remember that
  ...
  # Tell Action Mailer not to
  # deliver emails to the real world.
  # The :test delivery method accumulates
  # sent emails in the
